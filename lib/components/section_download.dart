      ...
      [
        ...
        div(classes: 'flex flex-col sm:flex-row gap-4 md:gap-8 lg:gap-12 text-gray-100', [
          for (var download in downloads)
            div(
              classes:
                  'flex flex-col max-w-[420px] items-center p-4 md:p-8 lg:p-12 rounded-xl bg-gray-700/30 shadow-lg',
              [
                ...
                for (var link in download.links)
                  div(classes: 'relative inline-block mt-2', [
                    if (link.label != null)
                      ...
                      div(
                        classes:
                            'flex flex-row w-40 px-4 py-2 my-1 bg-brand-600 border border-transparent hover:border-brand-500 rounded-full justify-center cursor-default opacity-50',
                        [
                          if (link.icon != null)
                            img(
                          ...
                          if (link.label != null) span(classes: '', [.text(link.label!)]),
                        ],
                      )
                    ...
                    span(
                      classes:
                          'absolute -top-1 -right-2 text-[10px] bg-brand-600 text-white px-2 py-0.5 rounded-full shadow-md border border-white cursor-default',
                      [.text('Coming soon')],
                    ),
                  ]),
              ],
