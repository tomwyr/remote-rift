      ...
      [
        for (var i = 0; i < setupSteps.length; i++)
          li(
            ...
            [
              span(classes: 'text-[.8rem] font-extrabold tracking-[.12em] text-gold-ink', [.text('0${i + 1}')]),
              h3(classes: 'my-3 min-h-[3rem] font-serif text-[1.35rem]', [.text(setupSteps[i].title)]),
