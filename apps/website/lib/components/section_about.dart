...
class const SectionAbout({super.key}) extends StatelessComponent {
  @override
  Component build(BuildContext context) => header(
    id: 'overview',
    classes: 'site-hero min-h-screen min-h-[100svh] border-b border-gold/70 bg-[linear-gradient(90deg,transparent_0,transparent_calc(100%-1px),color-mix(in_srgb,var(--color-rift-blue)_5%,transparent)_calc(100%-1px)),linear-gradient(0deg,transparent_0,transparent_calc(100%-1px),color-mix(in_srgb,var(--color-rift-blue)_3%,transparent)_calc(100%-1px))] bg-[size:8rem_8rem]',
    [
      const Navbar(),
      div(
        classes: 'mx-auto grid min-h-[calc(100svh-5rem)] max-w-304 grid-cols-[minmax(0,1fr)_minmax(22rem,.9fr)] items-center gap-16 px-6 py-12 max-[800px]:min-h-0 max-[800px]:grid-cols-1 max-[800px]:gap-10 landscape:max-[800px]:grid-cols-[minmax(0,1fr)_auto] landscape:max-[800px]:gap-6 landscape:max-[800px]:py-8',
        [
          div([
            span(
            ...
            div(
              ...
              [
                a(
                  href: '#how-it-works',
                  classes: 'max-[480px]:flex-1 border border-gold bg-navy px-[1.1rem] py-[.8rem] text-center text-[.9rem] font-bold tracking-[.04em] text-highlight no-underline transition-colors duration-200 hover:border-navy hover:bg-gold hover:text-navy',
                  [.text('How it works')],
                ),
                a(
                  href: '#install',
                  classes: 'max-[480px]:flex-1 border border-navy px-[1.1rem] py-[.8rem] text-center text-[.9rem] font-bold tracking-[.04em] no-underline transition-colors duration-200 hover:border-cyan hover:bg-cyan hover:text-navy',
                  [.text('Downloads')],
                ),
              ],
            ),
