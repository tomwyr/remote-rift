  ...
  Component build(BuildContext context) => section(
    ...
    [
      div(classes: 'mb-11 max-w-[43rem] border-l-[3px] border-gold pl-5', [
        span(classes: 'mb-[.9rem] block text-[.75rem] font-extrabold tracking-[.16em] text-gold', [.text('GET STARTED')]),
      ...
      ol(classes: 'mb-8 grid grid-cols-5 gap-3 p-0 max-[800px]:grid-cols-2 max-[540px]:grid-cols-1', [
        for (final step in [
      ...
      p(
        classes: 'my-8 flex max-w-[43rem] items-start gap-[.6rem] border-l-2 border-cyan bg-panel/60 px-4 py-3 text-[.9rem] text-[#d8e4ee]',
        [
          span(classes: 'inline-flex size-[1.2rem] shrink-0 items-center justify-center font-black text-ready', [
            .text('◇'),
          ]),
          .text(requirements),
        ],
                ...
                for (final link in download.links)
                  button(
                    ...
                    [
                      ...
                      small(classes: 'w-fit bg-gold px-2 py-[.15rem] text-[.65rem] font-extrabold uppercase tracking-[.08em] text-navy', [.text('Coming soon')]),
                    ],
                  ),
              ]),
            ],
