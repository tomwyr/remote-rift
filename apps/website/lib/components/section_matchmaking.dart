        ...
        [
          div(
            ...
            [
              ...
              ul(
                classes:
                    'grid list-none grid-cols-2 gap-x-4 gap-y-[.55rem] p-0 max-[540px]:grid-cols-1',
                [
          ...
          div(classes: 'pt-4 text-[1.1rem]', [
            ...
            p(classes: 'mb-4', [
              .text('Choose from the queues currently available in the League Client.'),
            ]),
            div(classes: 'flex flex-wrap gap-2', [
              for (final group in queueGroups)
                span(classes: 'border border-cyan/60 px-[.6rem] py-[.4rem] text-[.84rem]', [
                  .text(group),
                ]),
            ]),
          ]),
