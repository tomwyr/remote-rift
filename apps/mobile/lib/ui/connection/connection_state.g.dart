...
abstract class _$ConnectionErrorCWProxy {
  ConnectionError cause(ConnectionErrorCause cause);
  ...
  /// ```
  ConnectionError call({ConnectionErrorCause cause, bool reconnectTriggered});
}
...
class _$ConnectionErrorCWProxyImpl implements _$ConnectionErrorCWProxy {
  ...
  @override
  ConnectionError cause(ConnectionErrorCause cause) => call(cause: cause);
